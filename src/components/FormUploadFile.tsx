...
export default function FormUploadFile({
  ...
  return (
    <div
      className={
        (showForm ? "" : " translate-x-full") +
        " bg-zinc-500/50 fixed inset-0 flex items-center justify-center duration-200 z-50"
      }
    >
      <form className="bg-zinc-950 min-w-[300px] max-w-[600px]">
